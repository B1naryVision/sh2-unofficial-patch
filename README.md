...
| [Shift-click batch recruitment](docs/features/shift-click-recruitment.md) | `base+0x22083a`, `base+0x223ca9`, `base+0x223dc9`, `base+0x225622`, `base+0x228539`, `base+0x5ccba4` | Added in v0.6.0 |
...
| [Configurable camera pan speed (opt-in)](docs/features/pan-speed.md) | `base+0x1f9d86` | Added in v0.7.0 |
